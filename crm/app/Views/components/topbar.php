<header class="nxl-header">
    <div class="header-wrapper">
        <div class="header-left d-flex align-items-center gap-3">
            <button type="button" class="nxl-head-mobile-toggler border-0 bg-transparent" aria-label="Abrir navegación"><i class="feather-menu"></i></button>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        <img src="<?= base_url('assets/images/avatar.svg') ?>" alt="user-image" class="img-fluid user-avtar me-0" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="<?= base_url('assets/images/avatar.svg') ?>" alt="user-image" class="img-fluid user-avtar" />
                                <div>
                                    <h6 class="text-dark mb-0"><?= esc(session('user.nombre') ?? '') ?></h6>
                                    <span class="fs-12 fw-medium text-muted"><?= esc(session('user.correo') ?? '') ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php $ucomercial = $ucomercial ?? []; $ucomercial_id = $ucomercial_id ?? (int) session('user.ucomercial_id'); foreach ($ucomercial as $key => $value) { ?>
                            <a class="dropdown-item <?php if ($ucomercial_id == $value['id']) { echo 'active';} ?>" href="#" onclick="changeUC(<?= $value['id']; ?>)">
                                <i class="fas fa-people-carry fa-sm fa-fw mr-2"></i><?= $value['nombre']; ?>
                            </a>
                        <?php } ?>
