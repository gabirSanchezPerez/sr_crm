...
<?php if (! $isNew): ?>
    ...
    <?= view('proposals/subpanel', ['proposals' => $proposals, 'parentType' => 'cliente', 'parentId' => (int) ($customer['id'] ?? 0), 'canAddProposal' => $canAddProposal, 'canEditProposal' => $canEditProposal, 'canDeleteProposal' => $canDeleteProposal]) ?>
